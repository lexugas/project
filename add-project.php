...
if (isset($_POST['submit'])){
	...
	$cancel = true;
	// echo $authornum;
	$sql = "INSERT INTO docs (docs_title, docs_keyword, docs_abstract, docs_type1, docs_date , docs_status) VALUES ('$title', '$keyword', '$abstract', '$course', '$date', 1)";
